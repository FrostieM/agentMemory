"""Promote durable, high-trust candidates into behavior memory.
...
and thresholds, write a canonical behavior keyed on the candidate subject.
"""
    ...
    *,
    ...
    for candidate in candidates:
        ...
        upsert_behavior_instruction(
            conn,
            behavior_payload_from_candidate(candidate, workspace_id=workspace_id),
        )
        promoted += 1
