"""Unit tests for scripts/v3_acceptance_gate.py.
...
import pytest
from scripts import v3_acceptance_gate as gate

from agent_memory_lite.v3.cognition import brief as brief_mod
