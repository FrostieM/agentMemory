...
def test_get_context_limits_decisions_by_query(client: TestClient) -> None:
    ...
    # MAX_DECISIONS = 10. The query-ranked filter still drops irrelevant
    # decisions; the test asserts the per-section cap is enforced even
    # when the budget allows more.
    assert text.count("<decision ") <= 10
