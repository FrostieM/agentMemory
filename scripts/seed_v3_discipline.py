...
Usage::
    ...
    python scripts/seed_v3_discipline.py --workspace <id> --db-path <path>
    python scripts/seed_v3_discipline.py --workspace <id> --json
"""
...
V3_DISCIPLINE_RULES: list[dict[str, Any]] = [
    {
    ...
    *,
    ...
    conn.execute(
        ...
        INSERT INTO behaviors (
            ...
            'system_wins', 'seed_v3_discipline', NULL, NULL, 'system',
...
def seed_discipline(conn: sqlite3.Connection, *, workspace_id: str) -> list[SeedResult]:
    ...
    for rule in V3_DISCIPLINE_RULES:
